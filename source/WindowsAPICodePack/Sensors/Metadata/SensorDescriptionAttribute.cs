...
{
	/// <summary>
	/// An attribute which is applied on <see cref="Sensor"/>-derived types. Provides essential metadata such as the GUID of the sensor type
	/// for which this wrapper was written.
	/// </summary>
	...
	public sealed class SensorDescriptionAttribute : Attribute
	{
		...
		/// <summary>Gets a string representing the sensor type GUID.</summary>
		public string SensorType => _sensorType.ToString();

		/// <summary>Gets the GUID of the sensor type.</summary>
