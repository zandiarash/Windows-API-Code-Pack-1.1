...
{
    /// <summary>Sensor Property Key identifiers. This class will be removed once wrappers are developed.</summary>
    public static class SensorPropertyKeys
    {
        /// <summary>The sensor gravitational acceleration (X-axis) property key.</summary>
        ...
        /// <summary>The sensor gravitational acceleration (Y-axis) property key.</summary>
        ...
        /// <summary>The sensor gravitational acceleration (Z-axis) property key.</summary>
        ...
        /// <summary>The sensor altitude in meters property key.</summary>
        ...
        /// <summary>The sensor altitude from sea level in meters property key.</summary>
        ...
        /// <summary>The sensor angle in degrees (X-axis) property key.</summary>
        ...
        /// <summary>The sensor angle in degrees (Y-axis) property key.</summary>
        ...
        /// <summary>The sensor angle in degrees (Z-axis) property key.</summary>
        ...
        /// <summary>The sensor angular acceleration per second (X-axis) property key.</summary>
        ...
        /// <summary>The sensor angular acceleration per second (Y-axis) property key.</summary>
        ...
        /// <summary>The sensor angular acceleration per second (Z-axis) property key.</summary>
        ...
        /// <summary>The sensor boolean switch array state data property key.</summary>
        ...
        /// <summary>The sensor boolean switch data property key.</summary>
        ...
        /// <summary>The sensor distance (X-axis) data property key.</summary>
        ...
        /// <summary>The sensor distance (Y-axis) data property key.</summary>
        ...
        /// <summary>The sensor distance (Z-axis) data property key.</summary>
        ...
        /// <summary>The sensor data fix quality property key.</summary>
        ...
        /// <summary>The sensor data fix type property key.</summary>
        ...
        /// <summary>The sensor force (in newtons) data property key.</summary>
        ...
        /// <summary>The sensor horizontal dilution of precision property key.</summary>
        ...
        /// <summary>The sensor human presence data property key.</summary>
        ...
        /// <summary>The sensor human proximity data property key.</summary>
        ...
        /// <summary>The sensor latitude in degrees property key.</summary>
        ...
        /// <summary>The sensor light data property key.</summary>
        ...
        /// <summary>The sensor longitude in degrees property key.</summary>
        ...
        /// <summary>The sensor magnetic heading in degrees property key.</summary>
        ...
        /// <summary>The sensor magnetic heading (X-axis) property key.</summary>
        ...
        /// <summary>The sensor magnetic heading (Y-axis) property key.</summary>
        ...
        /// <summary>The sensor magnetic heading (Z-axis) property key.</summary>
        ...
        /// <summary>The sensor magnetic variation property key.</summary>
        ...
        /// <summary>The sensor multi-value switch data property key.</summary>
        ...
        /// <summary>The sensor position dilution of precision property key.</summary>
        ...
        /// <summary>The sensor pressure data property key.</summary>
        ...
        /// <summary>The sensor 40-bit RFID tag data property key.</summary>
        ...
        /// <summary>The sensor view property key.</summary>
        ...
        /// <summary>The sensor elevation property key.</summary>
        ...
        /// <summary>The sensor speed in knots property key.</summary>
        ...
        /// <summary>The sensor strain data property key.</summary>
        ...
        /// <summary>The sensor temperature in celsius property key.</summary>
        ...
        /// <summary>The sensor date time property key.</summary>
        ...
        /// <summary>The sensor true heading in degrees property key.</summary>
        ...
        /// <summary>The sensor vertical dilution of precision property key.</summary>
        ...
        /// <summary>The sensor weight (in kilograms) data property key.</summary>
