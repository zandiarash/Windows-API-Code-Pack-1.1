...
namespace Microsoft.WindowsAPICodePack.Sensors
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the Microsoft.WindowsAPICodePack.Sensors.SensorPlatformException class with the specified detailed description.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the Microsoft.WindowsAPICodePack.Sensors.SensorPlatformException class with the last Win32 error
		/// that occurred.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the Microsoft.WindowsAPICodePack.Sensors.SensorPlatformException class with the specified detailed
		...
		/// <summary>
		/// Initializes a new instance of the Microsoft.WindowsAPICodePack.Sensors.SensorPlatformException class with the specified context
