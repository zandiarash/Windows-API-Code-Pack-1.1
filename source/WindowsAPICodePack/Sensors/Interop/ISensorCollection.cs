...
{
	/// <summary>A COM interop wrapper for the ISensorCollection interface</summary>
	...
	/// <summary>A COM interop wrapper for the SensorCollection class</summary>
	...
	internal class SensorCollection : ISensorCollection
	{
		...
		public extern virtual void GetAt([In] uint index, [MarshalAs(UnmanagedType.Interface)] out ISensor ppSensor);

		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		public extern virtual void GetCount(out uint pCount);

		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		public extern virtual void Add([MarshalAs(UnmanagedType.Interface)] ISensor pSensor);

		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		public extern virtual void Remove([MarshalAs(UnmanagedType.Interface)] ISensor pSensor);

		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		public extern virtual void RemoveByID([In, MarshalAs(UnmanagedType.LPStruct)] Guid sensorId);
