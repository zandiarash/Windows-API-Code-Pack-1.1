...
namespace Microsoft.WindowsAPICodePack.Sensors
{
	...
	internal interface ISensor
	{
		...
		/// <summary>Sensor metadata: make, model, serial number, etc</summary>
		...
		/// <summary>Bulk Sensor metadata query: make, model, serial number, etc</summary>
		...
		/// <summary>Get the array of SensorDataField objects that describe the individual values that can be reported by the sensor</summary>
		...
		/// <summary>Bulk Sensor metadata set for settable properties</summary>
		...
		/// <summary>Reports the set of event interests.</summary>
		/// <param name="pValues"></param>
		/// <param name="count"></param>
		void GetEventInterest(
			out IntPtr pValues, [Out] out uint count);

		/// <summary>Sets the set of event interests</summary>
		...
		/// <summary>Subscribe to ISensor events</summary>
